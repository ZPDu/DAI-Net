...
def train_aet_detector(model,
    ...
    #print('11111111111', model.aet_head)
    print('backbone_number:', sum(param.numel() for param in model.backbone.parameters()))
    print('neck_number:', sum(param.numel() for param in model.neck.parameters()))
    print('neck_number:', sum(param.numel() for param in model.bbox_head.parameters()))
    # print('roi_head_number:', sum(param.numel() for param in model.roi_head.parameters()))
...
def train_SR_detector(model,
    ...
    print('srbone_number:', sum(param.numel() for param in model.sr_bone.parameters()))
    # if model.aet in locals().keys():
    #print('aet_number:', sum(param.numel() for param in model.aet.parameters()))
    print('backbone_number:', sum(param.numel() for param in model.backbone.parameters()))
    print('neck_number:', sum(param.numel() for param in model.neck.parameters()))
    print('head_number:', sum(param.numel() for param in model.bbox_head.parameters()))
    ...
    #print('11111111111111', next(model.parameters()).device)
